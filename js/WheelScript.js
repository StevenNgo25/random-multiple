...
const data = [
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Akhil', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Andy Y.', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Andy B.', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'David', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Davy', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Jonathan', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Leo', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Marcos', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Nick', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Tyler', id: generateGUID() },
    { fillStyle: '#' + Math.floor(Math.random() * 16777215).toString(16), text: 'Ver', id: generateGUID() },
]
...
function alertPrize(indicatedSegment) {
    ...
    const resultIds = getRandomResults(nameList.map(item => item.id), numResult);
    const results = nameList.filter(item => resultIds.includes(item.id));
    localStorage.setItem('resultText', JSON.stringify(results));
    resultsHistoryElement.value += results.map(item => item.text).join(', ') + '\n';
...
function renderWheel() {
    let showNameList = nameList.length > 10 ? getRandomResults(nameList, 10) : nameList;
    if(nameList.length > 10) showNameList.push({
        text: '...',
